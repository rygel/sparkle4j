 ...
 *
 * @param title Human-readable title of the update (from {@code <title>})
 ...
 * @param url Download URL for the installer file (from {@code url} attribute of {@code
 *     <enclosure>})
 * @param length Expected file size in bytes (from {@code length} attribute of {@code <enclosure>})
 ...
 * @param pubDate Publication date string from {@code <pubDate>}
 * @param os Target OS (from {@code sparkle:os}): "windows", "macos", or "linux"
