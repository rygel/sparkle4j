...
class VersionComparatorTest {
    ...
    @Test @DisplayName("sorts list by version descending")
    void sortDescending() {
    ...
    @Test @DisplayName("rc.2 is newer than rc.1")
    void rcOrdering() {
