...
class UpdateDialogTest {
    ...
    void dialogShowsHeader() throws Exception {
        var ud = new UpdateDialog(config(), item(), v -> {}, (i, p) -> {});
        showNonModal(ud);
    ...
    void skipButtonCallsOnSkip() throws Exception {
        ...
        var ud = new UpdateDialog(config(), item(), skipped::set, (i, p) -> {});
        showNonModal(ud);
    ...
    void remindLaterClosesDialog() throws Exception {
        ...
        var ud = new UpdateDialog(config(), item(), v -> skipped.set(true), (i, p) -> {});
        showNonModal(ud);
    ...
    void criticalUpdateHidesSkip() throws Exception {
        var ud = new UpdateDialog(config(), criticalItem(), v -> {}, (i, p) -> {});
        showNonModal(ud);
    ...
    void installButtonStartsDownload() throws Exception {
        ...
        var ud = new UpdateDialog(config(), item(), v -> {}, (i, p) -> installCalled.countDown());
        showNonModal(ud);
